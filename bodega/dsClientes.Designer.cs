...
namespace bodega {
    ...
    public partial class dsClientes : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clientesRow AddclientesRow(string Cliente, string Nombre, string Apellidos, string Direccion, string Telefono, string Correo_e) {
            ...
            private void InitClass() {
                ...
                this.columnCorreo_e.MaxLength = 30;
            }
        ...
        public partial class clientesRow : global::System.Data.DataRow {
            ...
            public string Correo_e {
                get {
                    try {
                        return ((string)(this[this.tableclientes.Correo_eColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Correo_e\' de la tabla \'clientes\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableclientes.Correo_eColumn] = value;
                }
            }
            ...
            public bool IsCorreo_eNull() {
                return this.IsNull(this.tableclientes.Correo_eColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetCorreo_eNull() {
                this[this.tableclientes.Correo_eColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace bodega.dsClientesTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[clientes] WHERE (([Cliente] = @Original_Cliente) AND ([Nombre] = @Original_Nombre) AND ([Apellidos] = @Original_Apellidos) AND ([Direccion] = @Original_Direccion) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Correo_e = 1 AND [Correo_e] IS NULL) OR ([Correo_e] = @Original_Correo_e)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[clientes] ([Cliente], [Nombre], [Apellidos], [Direccion], [Telefono], [Correo_e]) VALUES (@Cliente, @Nombre, @Apellidos, @Direccion, @Telefono, @Correo_e);
SELECT Cliente, Nombre, Apellidos, Direccion, Telefono, Correo_e FROM clientes WHERE (Cliente = @Cliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [Cliente] = @Cliente, [Nombre] = @Nombre, [Apellidos] = @Apellidos, [Direccion] = @Direccion, [Telefono] = @Telefono, [Correo_e] = @Correo_e WHERE (([Cliente] = @Original_Cliente) AND ([Nombre] = @Original_Nombre) AND ([Apellidos] = @Original_Apellidos) AND ([Direccion] = @Original_Direccion) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Correo_e = 1 AND [Correo_e] IS NULL) OR ([Correo_e] = @Original_Correo_e)));
SELECT Cliente, Nombre, Apellidos, Direccion, Telefono, Correo_e FROM clientes WHERE (Cliente = @Cliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Cliente, Nombre, Apellidos, Direccion, Telefono, Correo_e FROM dbo.cliente" +
                "s";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Cliente, Nombre, Apellidos, Direccion, Telefono, Correo_e\r\nFROM    " +
                "        clientes\r\nWHERE        (Nombre LIKE @cadena) OR\r\n                       " +
                "  (Apellidos LIKE @cadena)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cadena", global::System.Data.SqlDbType.NVarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "Nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByNombreApellidos(dsClientes.clientesDataTable dataTable, string cadena) {
        ...
        public virtual dsClientes.clientesDataTable GetDataByNombreApellidos(string cadena) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((cadena == null)) {
                throw new global::System.ArgumentNullException("cadena");
            }
        ...
        public virtual int Delete(string Original_Cliente, string Original_Nombre, string Original_Apellidos, string Original_Direccion, string Original_Telefono, string Original_Correo_e) {
            ...
            if ((Original_Correo_e == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_Correo_e));
            }
        ...
        public virtual int Insert(string Cliente, string Nombre, string Apellidos, string Direccion, string Telefono, string Correo_e) {
            if ((Cliente == null)) {
        ...
        public virtual int Update(string Cliente, string Nombre, string Apellidos, string Direccion, string Telefono, string Correo_e, string Original_Cliente, string Original_Nombre, string Original_Apellidos, string Original_Direccion, string Original_Telefono, string Original_Correo_e) {
            if ((Cliente == null)) {
                throw new global::System.ArgumentNullException("Cliente");
            }
            else {
            ...
            if ((Original_Correo_e == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_Correo_e));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellidos, string Direccion, string Telefono, string Correo_e, string Original_Cliente, string Original_Nombre, string Original_Apellidos, string Original_Direccion, string Original_Telefono, string Original_Correo_e) {
            return this.Update(Original_Cliente, Nombre, Apellidos, Direccion, Telefono, Correo_e, Original_Cliente, Original_Nombre, Original_Apellidos, Original_Direccion, Original_Telefono, Original_Correo_e);
        }
    }
